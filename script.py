                                    ...
                                    if itm == "parameters":
                                        for para in req[header][itm]:
                                            if para == "otp":
                                                ...
                                                print (req[header][itm][para])
                                                if p.match(str(req[header][itm][para])):
                                                    respo = {"fulfillmentText": "Do you wanna apply for loan or track your request?","fulfillmentMessages": [{"card":{"buttons": [{"text": "Apply Loan", "postback": "Apply for Loan"},{"text": "Service Request", "postback": "Raise a Request"}]}}],"source": "example.com","payload": {},"outputContexts": [ ],"followupEventInput": {}}
                                                    return jsonify(respo)
                                                else:
