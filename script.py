                                    ...
                                    if itm == "parameters":
                                        for para in req[header][itm]:
                                            if para == "otp":
                                                ...
                                                print (req[header][itm][para])
                                                if p.match(str(req[header][itm][para])):
                                                    respo = {"fulfillmentText": "OTP has been verified successfully. Do you wanna apply for loan or track your request?","fulfillmentMessages": [],"source": "example.com","payload": {},"outputContexts": [ ],"followupEventInput": {"name": "agr"}}
                                                    return jsonify(respo)
                                                else:
